	...
	*/
	...
	const textStrings = {
		en: {
			...
			goToLanguageChange: "Go to Language Change",
			goToAccessibilitySettings: "Go to Accessibility Settings",
			goToLoggingInToApps: "Go to Logging In To Apps",
			goToYourPhone: "Go to Your Phone",
		},
		fr: {
			...
			goToLanguageChange: "Aller au changement de langue",
			goToAccessibilitySettings: "Aller aux paramètres d'accessibilité",
			goToLoggingInToApps: "Aller à la connexion aux applications",
			goToYourPhone: "Aller à votre téléphone",
		},
		es: {
			...
			goToLanguageChange: "Ir al cambio de idioma",
			goToAccessibilitySettings: "Ir a la configuración de accesibilidad",
			goToLoggingInToApps: "Ir a la sesión en aplicaciones",
			goToYourPhone: "Ir a tu teléfono",
		},
		ch: {
			languageChange: "语言更改",
			...
			yourPhone: "你的电话",
			goToLanguageChange: "转到语言更改",
			goToAccessibilitySettings: "转到辅助功能设置",
			goToLoggingInToApps: "转到登录应用",
			goToYourPhone: "转到你的电话",
		},
		ru: {
			...
			goToLanguageChange: "Перейти к изменению языка",
			goToAccessibilitySettings: "Перейти к настройкам доступности",
			goToLoggingInToApps: "Перейти к входу в приложения",
			goToYourPhone: "Перейти к вашему телефону",
		},
		ar: {
			...
			yourPhone: "هاتفك",
			goToLanguageChange: "انتقل إلى تغيير اللغة",
			goToAccessibilitySettings: "انتقل إلى إعدادات الوصول",
			goToLoggingInToApps: "انتقل إلى تسجيل الدخول إلى التطبيقات",
			goToYourPhone: "انتقل إلى هاتفك",
		},
		hi: {
			...
			yourPhone: "आपका फ़ोन",
			goToLanguageChange: "भाषा बदलने जाएं",
			goToAccessibilitySettings: "पहुंचनीयता सेटिंग्स पर जाएं",
			goToLoggingInToApps: "ऐप्स में लॉगिन करने जाएं",
			goToYourPhone: "अपने फ़ोन पर जाएं",
		},
		ja: {
			...
			yourPhone: "あなたの電話",
			goToLanguageChange: "言語の変更へ",
			goToAccessibilitySettings: "アクセシビリティ設定へ",
			goToLoggingInToApps: "アプリにログインする",
			goToYourPhone: "あなたの電話へ",
		},
	};
