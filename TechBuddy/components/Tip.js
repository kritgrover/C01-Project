                ...
                <Modal animationType="slide" transparent={true} visible={showTip}>
                    <View style={TipStyle.modalContent}>
                        ...
                        <View style={TipStyle.body}>
                            ...
                            <VoiceCommand language={selectedLanguage} color={'white'} refs={[{ trigger: textStrings[selectedLanguage].nextTip, actual: nextRef }, { trigger: textStrings[selectedLanguage].dismiss, actual: dismissRef }]}></VoiceCommand>
