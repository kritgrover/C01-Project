...
with_node \
  ...
  --target "/Users/rkwan/Documents/UTSC/c01/c01w24-project-techbuddy/TechBuddy/ios/Pods/Target Support Files/Pods-TechBuddy/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-av" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-keep-awake" "expo-secure-store" "expo-speech"
